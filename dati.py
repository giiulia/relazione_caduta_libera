...
h4 = np.array([50.4, 50.5, 50.4, 50.5])/100
h5 = np.array([45.0, 45.1, 45.0, 45.1])/100
h6 = np.array([39.5, 39.6, 39.7, 39.5])/100
...
print("le medie dei tempi sono: {}".format(tempi))
...
print("le medie delle altezze sono: {}".format(altezze))
